...
def upload_to_vk(video_path, description="", title=""):
    ...
    try:
        ...
        # Prepare message
        message = description if description else "💔 Elara Voss Daily!\n\n#elaravoss #love #relationships #heartbreak"
        ...
        video = upload.video(
            ...
            name=title or 'Elara Voss Video',
...
def main():
    ...
    description = sys.argv[2] if len(sys.argv) > 2 else "Real Talk on Love & Heartbreak 💔"
    title = sys.argv[3] if len(sys.argv) > 3 else "Elara Voss"
